  ...
  return (
    <>
      <div ref={headerRef} className="relative z-[100]">
        ...
        <div className="sticky top-0 bg-gradient-to-br from-[#0B1C2C] via-[#1a2f42] to-[#0B1C2C] text-white shadow-2xl border-b-4 border-[#C8A55C] z-[100]">
          ...
          {/* Search Bar */}
          {isSearchOpen && (
            <div className="border-t border-white/10 bg-gradient-to-br from-[#0B1C2C] via-[#1a2f42] to-[#0B1C2C] shadow-2xl">
      ...
      {activeDropdown && (
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 py-8 relative z-10 max-h-[80vh] overflow-y-auto">
            {menuItems
                          ...
                          {displayProducts.map((product: any) => {
                            ...
                            return (
                              <Link
                                ...
                                onClick={() => setActiveDropdown(null)}
                                className="group bg-white/20 hover:bg-white/30 rounded-lg p-4 transition-all border-2 border-[#FFD700]/50 hover:border-[#FFD700] backdrop-blur-sm hover:scale-105 shadow-lg text-center"
                              >
                                {image?.url && (
