...
export function FinderContent({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-white">
      <div className="p-4 bg-[#0B1C2C] text-white shrink-0 border-b-2 border-[#C8A55C]/30">
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-white overscroll-contain touch-pan-y">
