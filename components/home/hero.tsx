    ...
    <>
      <section className="relative w-full min-h-[600px] md:min-h-[650px] lg:min-h-[700px] overflow-hidden bg-[#0B1C2C]">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(11, 28, 44, 0.4) 0%, rgba(11, 28, 44, 0.5) 50%, rgba(11, 28, 44, 0.6) 100%), linear-gradient(90deg, rgba(11, 28, 44, 0.6) 0%, rgba(11, 28, 44, 0.4) 40%, rgba(11, 28, 44, 0.2) 70%, rgba(11, 28, 44, 0) 100%)",
          }}
        />
