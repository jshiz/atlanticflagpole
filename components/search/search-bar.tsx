      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          <Input
            ...
            className="w-full pl-10 pr-24 text-sm md:text-base h-11 md:h-12 text-center md:text-left bg-gray-50 border-gray-300 focus:bg-white focus:border-[#C8A55C] transition-all rounded-full shadow-sm"
          />
