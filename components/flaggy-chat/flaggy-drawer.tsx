        ...
        <div className="bg-[#0B1C2C] text-white p-6 relative shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <SheetTitle className="text-white font-serif text-2xl">Flaggy</SheetTitle>
                <p className="text-sm text-gray-300 flex items-center gap-2">
                  AI Assistant
                </p>
              </div>
            </div>
            <SheetClose className="text-gray-400 hover:text-white transition-colors bg-white/10 p-2 rounded-full hover:bg-white/20">
              <X className="w-5 h-5" />
            </SheetClose>
          </div>
        </div>
