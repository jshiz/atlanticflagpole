...
export function RightPanelNav() {
  ...
  return (
    <div className={cn(
      ...
      activePanel ? "h-[65vh] max-h-[600px]" : "h-[52px]",
      // Mobile: full width
      "left-0 right-0",
      ...
      {/* The Bar (Header) */}
      <div className="h-[52px] shrink-0 flex items-center justify-around px-2 border-t-2 border-[#C8A55C] bg-[#0B1C2C] md:border-t-0 md:rounded-t-2xl">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive 
                  ? "text-[#C8A55C] bg-gradient-to-br from-[#C8A55C] to-[#B69446] shadow-lg shadow-[#C8A55C]/30 scale-105" 
            ...
            >
              <Icon className={cn(
                ...
                isActive ? "scale-110 text-white" : button.color,
                !isActive && "group-hover:scale-110 group-hover:text-white"
              )} />
              
              {button.badge !== undefined && button.badge > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-gradient-to-br from-[#C8A55C] via-[#D4AF37] to-[#B69446] text-[#0B1C2C] text-[9px] font-extrabold w-4.5 h-4.5 rounded-full flex items-center justify-center border-2 border-[#0B1C2C] shadow-lg shadow-[#C8A55C]/50 z-10 animate-in zoom-in duration-300">
